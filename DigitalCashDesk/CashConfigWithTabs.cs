...
{
    public partial class CashConfigWithTabs : Form
    {
        private static CashConfigWithTabs m_singleton;
        ...
        private CashConfigWithTabs()
        {
            InitializeComponent();
        }

        public static CashConfigWithTabs Instance
        {
            get
            {
                if (null == m_singleton)
                    m_singleton = new CashConfigWithTabs();
